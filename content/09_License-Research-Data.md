...
<img src="https://github.com/ubc-library-rc/rdm/blob/rdm-pages/content/figures/work-in-progress.png" />
</p>
...
Creative Commons (CC) (HYPERLINK) is a non-profit organization that issues standardized and free licenses to protect your work when you share it. CC licenses are recognized and applicable internationally. 
...
- Using it for a systematic review analysis
- Using it to create a small startup business

Access the datasets here:
- Azadian, Amin; Protopopova, Alexandra, 2025, "Replication Data for: Stability in Cognitive and Behavioural Performance Varies Between Dog Breed Clades", https://doi.org/10.5683/SP3/8MC0X2, Borealis, V1
- Hives, Benjamin; Bruno D. Zumbo; Mark R. Beauchamp; Yan Liu; Eli Puterman, 2025, "COVID-19 Pandemic and Exercise (COPE) Trial: Engagement with exercise apps and psychological stress", https://doi.org/10.5683/SP3/SJYOUF, Borealis, V1
...
- OGL-BC version 2.0
- OGL-Vancouver version 1.0

The Open Government Licenses can be very similar to one another, but they can vary by attribution name and information provider. 
